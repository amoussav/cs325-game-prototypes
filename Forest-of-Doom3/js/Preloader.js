...
GameStates.makePreloader = function( game ) {
    ...
    return {
        ...
        preload: function () {
            ...
            game.load.audio('titleMusic', ['assets/Scary-Demon-Haunting.mp3']);
            //	+ lots of other required assets here
            game.load.audio('backgroundMusic', ['assets/Too-Crazy.mp3']);
            game.load.image('shadow', 'assets/shadow.png' );
            game.load.image('shadow2', 'assets/shadow2.png');
            game.load.image('tiles', 'assets/tiles.png');
            game.load.tilemap('map', 'assets/map.csv', null, Phaser.Tilemap.CSV);
            game.load.spritesheet('player', 'assets/sprite2.png', 32, 32);
        },
